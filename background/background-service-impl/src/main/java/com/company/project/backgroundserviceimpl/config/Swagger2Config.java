package com.company.project.backgroundserviceimpl.config;
...
public class Swagger2Config {
    ...
    private Predicate<RequestHandler> selector1 = RequestHandlerSelectors.basePackage("com.company.project.backgroundserviceimpl.controller");
