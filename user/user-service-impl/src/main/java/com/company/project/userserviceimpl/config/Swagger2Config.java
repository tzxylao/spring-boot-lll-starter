package com.company.project.userserviceimpl.config;
...
public class Swagger2Config {
    ...
    private Predicate<RequestHandler> selector1 = RequestHandlerSelectors.basePackage("com.company.project.userserviceimpl.controller");
