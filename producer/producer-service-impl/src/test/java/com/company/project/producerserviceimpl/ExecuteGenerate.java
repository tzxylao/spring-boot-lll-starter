...
import com.company.project.producerserviceimpl.generate.CodeGenerator;

import java.util.ArrayList;
import java.util.List;

import static com.company.project.producerserviceimpl.generate.CodeGenerator.*;
...
public class ExecuteGenerate {
    ...
    public static void example1() {
        generateByTableNames("unlock_order");
    }
